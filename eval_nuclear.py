...
from dataset import TumorRegion_NuclearLevel_Feat, get_train_test_ds_MultiCenter_region_trainwithTCGA
import datetime
import utliz
import random
...
def get_parser():
    ...
    parser.add_argument('--numClass', default=2, type=int, help='4:0/1/2/3, 3:12/3/4, 2:12/34')
...
if __name__ == '__main__':
    ...
    ExternalVal_ds = TumorRegion_NuclearLevel_Feat(ExternalTest, return_bag=True, patho_filter=patho_filter, numClass=args.numClass, allRegion=args.all_region)
    HuadongVal_ds = TumorRegion_NuclearLevel_Feat(HuadongTest, return_bag=True, patho_filter=patho_filter, numClass=args.numClass, allRegion=args.all_region)
    ...
    for epoch in range(start_epoch, args.epochs):
        eval(epoch=epoch, model=model, loader=[InternalVal_loader, ExternalVal_loader, HuadongVal_loader], dev=dev, writer=writer, num_classes=args.numClass)
